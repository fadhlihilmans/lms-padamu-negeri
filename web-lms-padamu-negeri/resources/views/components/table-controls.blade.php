...
<div class="flex flex-col sm:flex-row sm:items-center gap-3 px-6 py-4 bg-[#f8fafc] border-b border-[#c5c5d7]">
    ...
    <div class="flex-1 min-w-0">
        <div class="relative">
            ...
            <input
                ...
                class="w-full pl-10 pr-4 py-2.5 border border-[#c5c5d7] rounded-lg text-[14px] text-on-surface bg-white
    ...
    <div class="flex items-center gap-2 text-[14px] text-[#505f76] flex-shrink-0">
        ...
        <select
            ...
            class="border border-[#c5c5d7] rounded-lg px-3 py-2.5 text-[14px] text-on-surface bg-white
